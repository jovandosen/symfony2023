 ...
 */
final class Version20230606091614 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_3A374C658F93B6FC ON movie_actor');
        $this->addSql('DROP INDEX IDX_3A374C6510DAF24A ON movie_actor');
    }
}
